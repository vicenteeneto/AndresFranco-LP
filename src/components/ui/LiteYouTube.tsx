  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 flex items-center justify-center">
        <span
          className={`flex items-center justify-center rounded-full bg-gold pl-1 text-bg shadow-[0_2px_28px_rgba(196,168,106,.35)] transition-transform duration-500 group-hover:scale-105 ${
